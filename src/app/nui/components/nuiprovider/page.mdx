...
Unlike standard interactive UI widgets, `NUIProvider` is an application-level wrapper component. It injects and manages the `.dark` theme class on your root `<html>` or `<body>` element, ensuring that all NUICSS semantic design tokens automatically adapt to light and dark modes across all components.
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className="bg-page text-default min-h-screen">
...
export function ThemeSwitcher() {
  ...
  return (
    <div className="flex items-center gap-3 p-4 bg-surface border border-default rounded-lg">
      <span className="text-sm font-medium">
        Current Theme: <strong className="text-primary capitalize">{resolvedTheme}</strong>
      </span>
