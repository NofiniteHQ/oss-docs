...
| --bg-subtle        | Hover item, footer button background |
| --fg-default       | Text                                 |
| --fg-subtle        | Placeholder, inactive part toggle    |
| --fg-disabled      | Disabled text                        |
| --border-default   | Column borders, panel borders        |
| --border-hover     | Trigger hover border                 |
