...
| Token                      | Usage                     |
| -------------------------- | ------------------------- |
| --bg-subtle            | Track background          |
| --color-primary        | Fill color + thumb border |
| --bg-surface           | Thumb background          |
| --brand-50 / 100 / 600 | Hover + focus states      |
| --fg-muted             | Disabled styling          |
