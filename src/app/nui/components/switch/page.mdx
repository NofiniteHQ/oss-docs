...
| --color-primary      | Checked background |
| --color-primary-hover      | Checked hover      |
| --border-default | Off state          |
| --bg-page        | Focus ring offset  |
| --radius-full    | Track shape        |
| --space-3        | Layout spacing     |
| --fg-default     | Label text         |
| --fg-subtle      | Description text   |
