...
| Token                | Usage                          |
| -------------------- | ------------------------------ |
| --color-primary  | Active and completed indicator |
| --border-default | Connector line                 |
| --bg-surface     | Step circle background         |
| --fg-subtle      | Default text                   |
| --fg-muted       | Optional + description text    |
| --brand-50       | Active glow                    |
| --space-2        | Step spacing                   |
