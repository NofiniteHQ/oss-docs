...
A composable, accessible TreeView component for modern React applications.
...
| --fg-muted       | Chevron / icon color       |
| --bg-subtle      | Hover / focus background   |
| --color-primary  | Selected / focus outline   |
| --radius-md      | Node border radius         |
| --space-1        | Vertical padding           |
| --space-2        | Horizontal padding / gap   |
| text-sm        | Label font size            |
| --weight-medium  | Selected label font weight |
| --border-default | Chevron hover background   |
