...
| Token                | Usage                     |
| -------------------- | ------------------------- |
| --border-default | Handle divider color      |
| --color-primary  | Active/hover handle color |
| --bg-subtle      | Focus background          |
| --bg-surface     | Grip background           |
| --fg-muted       | Grip icon color           |
