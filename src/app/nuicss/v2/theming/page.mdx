...
For example, `colorsBg.brand` generates `--bg-brand: #ff0055`. This allows you to dynamically change themes at runtime (e.g. implementing a user-selectable theme color) without regenerating the CSS!
