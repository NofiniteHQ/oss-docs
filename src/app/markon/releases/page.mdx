...
**Latest version:** `v1.1.1` (01 February 2024)

This release of **Markon** represents the most recent published version of the library.

---

## Summary

**Markon** is a lightweight text formatting utility for both browser and React environments. It provides a simple, explicit syntax for enhancing text with formatting elements such as bold, underline, links, lists, emphasis, and line breaks.
